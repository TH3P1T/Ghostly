...
<head>
   ...
   <title>Ghostly - Method Not Allowed</title>
   <!-- =============== VENDOR STYLES ===============-->
   <!-- FONT AWESOME-->
   ...
   <div class="wrapper">
      <div class="abs-center wd-xl">
         ...
         <div class="text-center mb-4">
            <div class="text-lg mb-3">405</div>
            <p class="lead m-0">Method not allowed.</p>
            <p>The current route does not allow that method.</p>
            <p>Allowed Methods: <?= $allowed_methods ?></p>
         </div>
